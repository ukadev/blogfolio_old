...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{route('panelAdmin')}}" title="Go to Admin Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Projects</a> </div>
    </div>
    <!--End-breadcrumbs-->
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        <h5>Projects</h5>
                        <span class="label label-success"><a class="white" href="{{route('projectsAddAdmin')}}" title="Add new Post"><i class="icon-plus"></i> Add new Project</a></span>
                    </div>
                        ...
                        <table class="table table-bordered data-table">
                            ...
                            @foreach($projects as $id => $project)
                                <tr class="{{ ($id % 2 == 0) ? "gradeX" : "gradeC" }}">
                                    <td><a href="{{route('projectsEditAdmin', $project->id)}}">{{$project->title}}</a></td>
                                    <td> <span class="user-info">{{date('d/m/Y, h:i A', strtotime($project->created_at))}}</span></td>
                                    <td>
                                        <div class="text-right">
                                            <a class="btn btn-primary btn-mini" href="{{route('projectsEditAdmin', $project->id)}}"><i class="icon icon-edit"></i> Edit</a> | <a class="btn btn-danger btn-mini delPost" href="javascript:void(0)" data-post="{{$project->id}}" data-toggle="modal" data-target="#modalDel"><i class="icon icon-remove"></i> Delete</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modalDelLabel">Delete Project</h4>
                </div>
