...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{route('panelAdmin')}}" title="Go to Admin Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('blogAdmin')}}" title="Go to Posts Page" class="tip-bottom">Posts</a> <a href="#" class="current">Add Post</a> </div>
    </div>
    <!--End-breadcrumbs-->
    @if (count($errors) > 0)
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="{{route('postsStoreAdmin')}}" class="form-horizontal" method="post">
                            {{ csrf_field() }}
